    ...
    <section className="py-8 lg:py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="mb-4 lg:mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 lg:gap-0">
          <div>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#1e3a8a] mb-1 lg:mb-2">Correct Score Predictions</h2>
            ...
            <CardContent className="bg-gray-50 py-12 opacity-30">
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between p-2 bg-white rounded">
                  ...
                  <span className="text-sm font-bold text-[#1e3a8a]">Premium</span>
                </div>
                <div className="flex items-center justify-between p-2 bg-white rounded">
